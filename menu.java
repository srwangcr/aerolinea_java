...
public class menu {
    ...
    private void gestionPasajes() {
        ...
        switch (opcion) {
            case 0:
                ...
                break;
            case 1:
                JOptionPane.showMessageDialog(null, "Funcion de modificar vuelo en desarrollo.");
                break;
            case 2:
                JOptionPane.showMessageDialog(null, "Funcion de modificar datos en desarrollo.");
                break;
            case 3:
                cancelarReserva();
                break;
    ...
    private void procesoPago() {
        ...
        long tarjeta = pasajeActual.getNumeero_tarjeta();
        String resumenPago = "=== PROCESO DE PAGO ===\n\n"
                ...
                + "o Tarjeta: " + procesopago.ocultarTarjeta(tarjeta) + "\n"
                + "• Vencimiento: " + procesopago.mostrarFecha(pasajeActual.getFecha_vencimiento_tarjetaMes(), pasajeActual.getFecha_vencimiento_tarjetaAnio()) + "\n\n"
...
class PedirDatosUsuarioMejorado {
    ...
    public pasajes solicitarDatosCompletos() {
        ...
        if (ida_pasajeros_str == null) {
            return null;
        }
        if (ida_pasajeros_str.matches("\\d+")) {
        ...
        double ida_precio = precios[rand.nextInt(precios.length)]*ida_pasajeros;
        ...
        if (vuelta_pasajeros_str == null) {
            return null;
        }
        if (vuelta_pasajeros_str.matches("\\d+")) {
        ...
        double vuelta_precio = precios[rand.nextInt(precios.length)]*vuelta_pasajeros;
        ...
        if (vuelta_opcionesExtra == null) {
            vuelta_opcionesExtra = "";
        }
        ...
        if (telefono_str == null) {
            return null;
        }
        if (telefono_str.matches("\\d+")) {
        ...
        if (nombre_titular_tarjeta == null) {
            return null;
        }
        ...
        while (mesValidacion) {
            ...
            if (fecha_vencimiento_tarjetaMes_String == null) {
                return null;
            }
        ...
        while (AnioValidacion) {
            ...
            if (fecha_vencimiento_tarjetaAnio_String == null) {
                return null;
            }
        ...
        while (codigoValidacion) {
            ...
            if (codigo_seguridad_tarjeta_String == null) {
                return null;
            }
